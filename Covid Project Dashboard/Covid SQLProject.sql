--Removing null values from continents to make sure we get actual data
Select *
...
-- Also called PercentPopulationInfected
...
-- Using CTE to perform Calculation on Partition By in previous query because we cannot use the column we just created in the same query
...
Select *, (RollingPeopleVaccinated/Population)*100 as '%VaccinatedPeople_CountryPopulation'
From PopvsVac
...
select * from population_percentage_vaccinated